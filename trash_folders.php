                ...
                <div class="container-fluid mx-auto">
                    <div class="header">
                        ...
                        if ($folder->rowCount() > 0) {
                            foreach ($folder as $folderupload) {
                                ...
                                echo '<h1 class="header font-weight-semibold"><a href="trash.php" class="text-secondary header">Trash</a> <i class="fa-solid fa-angle-right small"></i> ' . $folderCategory . ' - ' . $folderName . '</h1>';
                            }
                        }
                        ?>
                    </div>
                    <div class="my-4">
                        ...
                        <div class="d-block d-md-flex d-md-flex-row justify-content-start flex-wrap" id="file-container">
                            ...
                            $folder->bindParam(':client_id', $client_id);
                            $folder->bindParam(':folder', $folderPath);
                            $folder->execute();

                            if ($folder->rowCount() > 0) {
                                foreach ($folder as $folderupload) {

                                    $folder = $conn->prepare("SELECT * FROM folder_upload WHERE folder_upload.client_id = :client_id AND parent_folder = '$folderPath' AND is_deleted = 1 ORDER BY id DESC");
                                    $folder->bindParam(':client_id', $client_id);
                                    $folder->execute();
                                            ...
                                            '<ul class="list-group list-unstyled" id="myFolder">
                                                <li class="list group" data-category="' . $folderupload['category'] . '">
                                                    <div class="col card shadow-sm p-2 my-1 my-md-3 mr-0 mr-md-1 mr-lg-3 d-flex" id="cardFile" style="max-width: 210px; min-width: 210px; min-height: 210px; max-height: 280px;" data-toggle="tooltip" title="Category: ' . $folderupload['category'] . '">
                                                        <a href="trash_inner_folder.php?parent_path=' . $parent_path . '&path=' . $folder_path . '" class="d-block mx-auto display-1 p-3 imageContainer">
                                                        ...
                                                        <div class="mt-auto px-1">
                                                            ...
                                                            <div class="d-flex justify-content-between">
                                                                ...
                                                                <div class="dropdown-menu">
                                                                    <a href="trash_inner_folder.php?parent_path=' . $parent_path . '&path=' . $folder_path . '" class="dropdown-item"><i class="fa-regular fa-folder-open"></i> Open</a>
