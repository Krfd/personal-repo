                    ...
                    <div class="header">
                        ...
                        if ($folder->rowCount() > 0) {
                            foreach ($folder as $folderupload) {
                                ...
                                echo '<h1 class="header font-weight-semibold"><a href="archive.php" class="text-secondary header">Archive</a> <i class="fa-solid fa-angle-right small"></i> <a href="archive_folders.php?path=' . $folderupload['parent_folder'] . '" class="text-secondary header">' . $parentFolder . '</a> <i class="fa-solid fa-angle-right small"></i> ' . $folderCategory . ' - ' . $folderName . '</h1>';
                            }
                        }
                        ?>
                    </div>
                        ...
                        <div class="d-block d-md-flex d-md-flex-row justify-content-start flex-wrap" id="file-container">
                            ...
                            if ($folder->rowCount() > 0) {
                                foreach ($folder as $folder_upload) {
                                    ...
                                    $file = $conn->prepare("SELECT * FROM file_upload WHERE file_upload.client_id = :client_id AND folder = '$mainFolder' AND file_id = file_id ORDER BY file_id DESC");
                                    ...
                                    if ($file->rowCount() > 0) {
                                        foreach ($file as $fileupload) {
                                            ...
                                            $page = "archive_inner_folder.php?parent_path=$parentPath" . "&" . "path=$mainFolder";
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form action="pdoaction.php" method="POST" class="user">
                                                                <input type="hidden" name="return" value="<?php echo "archive_inner_folder.php?parent_path=" . $parentPath . "&" . "path=" . $mainFolder ?>">
                                                                <!-- Key -->
