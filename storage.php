                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="pdoaction.php" method="POST" enctype="multipart/form-data" class="user">
                                ...
                                <!-- This should not be removed, used for the backend even empty -->
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content" class="bg-gradient-light">
                ...
                <div class="container-fluid mx-auto">
                    <div class="header">
                        <h1 class="font-weight-semibold">Storage</h1>
                    </div>
                    <!-- File Category -->
                    <div class="dropdown">
                    ...
                    <div class="my-4">
                        ...
                        <div class="d-block d-md-flex d-md-flex-row justify-content-start flex-wrap" id="file-container">
                            <?php
                            $folder = $conn->prepare("SELECT * FROM folder_upload WHERE folder_upload.client_id = :client_id AND parent_folder = '' AND is_deleted = 0 AND is_archive = 0 ORDER BY id DESC");
                            ...
                            if ($folder->rowCount() > 0) {
                                foreach ($folder as $folderupload) {
                                    ...
                                    $category = $folderupload['category'];
                                    ...
                                    '<ul class="list-group list-unstyled" id="myFolder">
                                        <li class="list-group" data-category="' . $folderupload['category'] . '">
                                            <div class="col card shadow-sm p-2 my-1 my-md-3 mr-0 mr-md-1 mr-lg-3 d-flex" id="cardFile" style="max-width: 210px; min-width: 210px; min-height: 210px; max-height: 210px;" data-toggle="tooltip" title="Category: ' . $folderupload['category'] . '">
                                                <a href="storage_folders.php?path=' . $folder_path . '" class="d-block mx-auto display-1 p-3 imageContainer">
                                                ...
                                                <div class="mt-auto px-1">
                                                    ...
                                                    <div class="d-flex justify-content-between">
                                                        ...
                                                        <div class="dropdown-menu">
                                                            <a href="storage_folders.php?path=' . $folder_path . '" class="dropdown-item"><i class="fa-regular fa-folder-open"></i> Open</a>
                                                            ...
                                                            <a href="archive/archive_folder.php?id=' . $folder_id . '&url=' . $page . '&folder=' . $folderupload['folder'] . '&client_id=' . $client_id . '&category=' . $category . '" class="dropdown-item" ><i class="fa-solid fa-box-archive"></i> Archive</a>
                                                            <a href="remove/remove_folder.php?id=' . $folder_id . '&url=' . $page . '&folder=' . $folderupload['folder'] . '&client_id=' . $client_id . '&category=' . $category . '" class="dropdown-item"><i class="fa-solid fa-trash"></i> Remove</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            if ($folder->rowCount() > 0) {
                                foreach ($folder as $folderupload) {
                                    $folder_id = $folderupload['id'];
                                    $folder_path = 'folders/' . $folderupload['folder'];
                                    $currentFolder = $folderupload['folder'];
                                    $parentFolder = $folderupload['parent_folder'];
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form action="pdoaction.php" method="POST" class="user">
                                                        ...
                                                        <input type="hidden" name="parentFolder" value="<?php echo $parentFolder ?>">
                                                        ...
                                                        <div class="modal-footer">
                                                            <button class="btn btn-danger" type="button" data-dismiss="modal"><i class="fa">&#xf00d;</i> Cancel</button>
                                                            <button type="submit" class="btn btn-primary" name="saveFolder"><i class="fas fa-check"></i> Save</button>
                                                        </div>
                                                    </form>
                                                </div>
                                            </div>
                    ...
                    <div class="my-4">
                        ...
                        <div class="d-block d-md-flex d-md-flex-row justify-content-start flex-wrap" id="file-container">
                            ...
                            $file = $conn->prepare("SELECT * FROM file_upload WHERE file_upload.client_id = :client_id AND folder = '' AND parent_folder = '' AND is_deleted = 0 AND is_archive = 0 ORDER BY file_id DESC");
                                ...
                                foreach ($file as $fileupload) {
                                    ...
                                    echo '<ul class="list-group" id="myList" >
                                        <li class="list-group" data-category="' . $fileupload['category'] . '">
                                            <div class="col card shadow-sm p-2 my-1 my-md-3 mr-0 mr-md-1 mr-lg-3 d-flex" id="cardFile" style="max-width: 210px; min-width: 210px; min-height: 210px; max-height: 210px">
                                                <a href=' . $file_path . ' target="_blank" class="imageContainer mx-auto" style="overflow: hidden; position:relative; text-decoration:none;" data-toggle="tooltip" title="Category: ' . $fileupload['category'] . '">';

                                    $extension = pathinfo($fileupload['fileName'], PATHINFO_EXTENSION);
                                    switch ($extension) {
                                        case "jpg":
                                            echo '<img src="files_upload/' . $fileupload['fileName'] . '" class="object-fit-cover h-auto w-100 btn p-0 rounded-0" alt=' . $fileupload['title'] . ' style="min-height: 150px;">';
                                            break;
                                        case "png":
                                            echo '<img src="files_upload/' . $fileupload['fileName'] . '" class="object-fit-cover h-auto w-100 btn p-0 rounded-0" alt=' . $fileupload['title'] . ' style="min-height: 150px;">';
                                            break;
                                        ...
                                        case "xlr":
                                            ...
                                            break;
                                        default:
                                            echo '<img src="img/text.png" class="object-fit-cover h-auto w-75 d-block mx-auto btn py-3 rounded-0" alt=' . $fileupload['title'] . '>';
                                            break;
                                    }
                                    ...
                                    echo '</a>
                                            <div class="mt-auto px-1">
                                                <small>' . $modified . '</small>
                                                <div class="d-flex justify-content-between">
                                                    <span class="overflow-hidden pr-2">' . $fileName . '</span>
                                                    <i class="fa-solid fa-ellipsis-vertical dropdown rounded-circle py-1 px-2 align-self-center" data-toggle="dropdown" type="button" id="toggleMenuOption"></i>
                                                        <div class="dropdown-menu">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form action="pdoaction.php" method="POST" class="user">
                                                        ...
                                                        <input type="hidden" name="uploaded" value="<?php echo $uploaded ?>" required>
                                                        <input type="hidden" name="updated" required>
