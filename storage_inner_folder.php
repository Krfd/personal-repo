...
<head>
    <!-- Custom CSS -->
    <link rel="stylesheet" href="css/innerfolders.css">
</head>
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            if ($folder->rowCount() > 0) {
                foreach ($folder as $folder_upload) {
                    ...
                    $parentPath = isset($_GET['parent_path']) ? htmlspecialchars($_GET['parent_path']) : '';
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form action="pdoaction.php" method="POST" enctype="multipart/form-data" class="user">
                                        ...
                                        <!-- Set a ascendant folder -->
                                        <input type="hidden" name="asc_folder" value="<?php echo $parentPath ?>">
                                        <!-- Variable that returns to the current page -->
                                        <input type="hidden" name="return" value="<?php echo "storage_inner_folder.php?parent_path=$parentPath" . "&" . "path=$folderPath" ?>">
            ...
            <div id="content" class="bg-gradient-light">
                ...
                <div class="container-fluid mx-auto">
                    <div class="header">
                        ...
                        $folder = $conn->prepare("SELECT folder_name, category, parent_folder FROM folder_upload WHERE folder_upload.client_id = :client_id AND folder_upload.folder = :folder_path ORDER BY id DESC");
                        $folder->bindParam(':client_id', $client_id);
                        ...
                        if ($folder->rowCount() > 0) {
                            foreach ($folder as $folderupload) {
                                ...
                                if (strlen($parentFolder) > 15) {
                                    $parentFolder = substr($parentFolder, 0, 13) . "...";
                                } else {
                                ...
                                echo '<h1 class="header font-weight-semibold"><a href="storage.php" class="text-secondary header">Storage</a> <i class="fa-solid fa-angle-right small"></i> <a href="storage_folders.php?path=' . $folderupload['parent_folder'] . '" class="text-secondary header">' . $parentFolder . '</a> <i class="fa-solid fa-angle-right small"></i> ' . $folderCategory . ' - ' . $folderName . '</h1>';
                            }
                        }
                        ?>
                    </div>
                        ...
                        <div class="d-block d-md-flex d-md-flex-row justify-content-start flex-wrap" id="file-container">
                            ...
                            if ($folder->rowCount() > 0) {
                                foreach ($folder as $folder_upload) {
                                    ...
                                    $parentPath = str_replace(" ", "%20", $parentPath);
                                    ...
                                    if ($file->rowCount() > 0) {
                                        foreach ($file as $fileupload) {
                                            ...
                                            $file_path = 'folders/' . $parentPath . "/" . $folderPath . "/" . $fileupload['fileName'];
                                            ...
                                            $page = "../storage_inner_folder.php?parent_path=$parentPath%26path=$mainFolder";
                                ...
                                <li class="list-group" data-category="' . $fileupload['category'] . '">
                                    <div class="col card shadow-sm p-2 my-1 my-md-3 mr-0 mr-md-1 mr-lg-3 d-flex" id="cardFile" style="max-width: 210px; min-width: 210px; min-height: 210px; max-height: 210px;">
                                        <a href=' . $file_path . ' target="_blank" class="imageContainer" style="overflow: hidden" style="position:relative" data-toggle="tooltip" title="Category: ' . $fileupload['category'] . '">';
                                            ...
                                            switch ($extension) {
                                                case "jpg":
                                                    echo '<img src="folders/' . $parentPath . " /" . $folderPath . "/" . $fileupload['fileName'] . '" class="object-fit-cover h-auto w-100 btn p-0 rounded-0" alt=' . $fileupload['title'] . ' style="min-height: 150px;">';
                                                    break;
                                                case "png":
                                                    echo '<img src="folders/' . $parentPath . "/" . $folderPath . "/" . $fileupload['fileName'] . '" class="object-fit-cover h-auto w-100 btn p-0 rounded-0" alt=' . $fileupload['title'] . ' style="min-height: 150px;">';
                                                    break;
                                                        ...
                                                        <div class="d-flex justify-content-between cardName" ">
                                                            <span class="overflow-hidden pr-3 cardName">' . $fileName . '</span>
                                                                ...
                                                                <div class="dropdown-menu">
                                                                    ...
                                                                    <a href="archive/archive_file.php?id=' . $file_id . '&url=' . $page . '&category=' . $category . '" class="dropdown-item" ><i class="fa-solid fa-box-archive"></i> Archive</a>
                                                                    <a href=' . $file_path . ' class="dropdown-item" download><i class="fa-solid fa-download"></i> Download</a>
                                                                    <a href="remove/remove_file.php?id=' . $file_id . '&url=' . $page . '&category=' . $category . '" class="dropdown-item"><i class="fa-solid fa-trash"></i> Remove</a>
                                                                </div>
                                                            </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form action="pdoaction.php" method="POST" class="user">
                                                                <input type="hidden" name="return" value="<?php echo "storage_inner_folder.php?parent_path=" . $parentPath . "&" . "path=" . $mainFolder ?>">
                                                                <!-- Key -->
                                                                <input type="hidden" name="key" value="<?php echo $key ?>">
                                                                <!-- Token -->
                                                                <input type="hidden" name="csrfToken" value="<?php echo $token ?>">
