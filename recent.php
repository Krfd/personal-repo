        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content" class="bg-gradient-light">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <ul class="navbar-nav ml-auto ">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="recent.php">
                ...
                <div class="container-fluid">
                    <div class="header">
                        <h1 class="font-weight-semibold">Recent</h1>
                    </div>
                    <!-- File Category -->
                    <div class="dropdown">
                    ...
                    <div class="my-4">
                        ...
                        <div class="d-block d-md-flex d-md-flex-row justify-content-start flex-wrap" id="file-container">
                            <?php
                            $folder = $conn->prepare("SELECT * FROM folder_upload WHERE folder_upload.client_id = :client_id AND parent_folder = '' AND is_deleted = 0 AND is_archive = 0 ORDER BY updated DESC LIMIT 10");
                                    ...
                                    <ul class="list-group list-unstyled" id="myFolder">
                                        <li class="list-group" data-category="' . $folderupload['category'] . '">
                                            <div class="col card shadow-sm p-2 my-1 my-md-3 mr-0 mr-md-1 mr-lg-3 d-flex" id="cardFile" style="max-width: 210px; min-width: 210px; min-height: 210px; max-height: 280px;" data-toggle="tooltip" title="Category: ' . $folderupload['category'] . '">
                                                <a href="recent_folders.php?path=' . $folder_path . '" class="d-block mx-auto display-1 p-3 imageContainer">
                                                    <i class="fa-solid fa-folder" style="color: #0275d8"></i>
                                                </a>
                                                <div class="mt-auto px-1">
                                                    <small>' . $modified . '</small>
                                                    <div class="d-flex justify-content-between">
                                                        <span class="overflow-hidden pr-3">' . substr($folderName, 0, 20) . '</span>
                                                        ...
                                                        <div class="dropdown-menu">
                                                            <a href="recent_folders.php?path=' . $folder_path . '" class="dropdown-item"><i class="fa-regular fa-folder-open"></i> Open</a>
                    ...
                    <div class="my-4">
                        ...
                        <div class="d-block d-md-flex d-md-flex-row justify-content-start flex-wrap" id="file-container">
                            ...
                            $file = $conn->prepare("SELECT * FROM file_upload WHERE file_upload.client_id = :client_id AND folder = '' AND is_deleted = 0 AND file_id = file_id AND is_archive = 0 ORDER BY updated DESC LIMIT 10");
                            $file->bindParam(':client_id', $client_id);
                            $file->execute();

                            if ($file->rowCount() > 0) {
                                foreach ($file as $fileupload) {
                                    // while ($fileupload = $file->fetch(PDO::FETCH_ASSOC)) {
