...
<body id="page-top">
    ...
    <div class="floating-container">
        ...
        <div class="element-container">
            <span class="float-element" data-toggle="modal" data-target="#addfile" data-toggle="tooltip" title="Add file">
                <i class="fa-solid fa-file font-weight-bold"></i>
            </span>
            <span class="float-element" data-toggle="modal" data-target="#addFolder" data-toggle="tooltip" title="Add folder">
    ...
    <div id="wrapper" style="height: 100vh;">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <?php
            $folder = $conn->prepare("SELECT folder, folder_name, category FROM folder_upload WHERE folder_upload.client_id = :client_id AND is_deleted = 0 AND is_archive = 0 ORDER BY id DESC");
            ...
            if ($folder->rowCount() > 0) {
                foreach ($folder as $folder_upload) {
                    ...
                    // Get the category list from a certain folder
                    $folderPath = isset($_GET['path']) ? htmlspecialchars($_GET['path']) : '';

                    $tempFolderPath = $folderPath;
                    if (strlen($tempFolderPath) > 15) {
                        $tempFolderPath = substr($tempFolderPath, 0, 13) . "...";
                    } else {
            ...
            ?>
                    ...
                    <div class="modal fade" id="addfile" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalLabel">Add File in <strong><?php echo $tempFolderPath ?></strong></h5>
                                ...
                                <div class="modal-body">
                                    <form action="pdoaction.php" method="POST" enctype="multipart/form-data" class="user">
                                        ...
                                        <!-- Set a parent folder -->
                                        <input type="hidden" name="parent_folder" value="<?php echo $folderPath ?>">
                                        <!-- Category -->
                                        <input type="hidden" name="category" value="<?php echo $category ?>">
                                        <!-- Variable that returns to the current page -->
                                        <input type="hidden" name="return" value="<?php echo "storage_folders.php?path=$folderPath" ?>">
                                        <!-- Variable for the folder where it belongs -->
                                        <input type="hidden" name="folder" value="<?php echo $folderPath ?>">
                                        ...
                                        $query_category = $conn->prepare("SELECT category FROM folder_upload WHERE folder = '$folderPath' AND client_id = :client_id");
                                        $query_category->bindParam(':client_id', $client_id);
                                        $query_category->execute();

                                        if ($query_category->rowCount() > 0) {
                                            foreach ($query_category as $category) {
                                                $folder_category = $category['category'];
                                                echo '<input type="hidden" name="category" value="' . $folder_category . '" required>';
                                            }
                                        }
                                        ?>
                    ...
                    <div class="modal fade" id="addFolder" tabindex="-1" role="dialog" aria-labelledby="exmapleModalLabel" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="emapleModalLabel">Add Folder in <strong><?php echo $folderPath ?></strong></h5>
                                </div>
                                <div class="modal-body">
                                    <form id="secondaryFolder" method="POST" class="user" enctype="multipart/form-data">
                                        <!-- Key -->
                                        ...
                                        <div class="form-group">
                                            <input type="text" class="form-control form-control-user" name="newFolder" id="folder" aria-checked="" placeholder="Folder name" autocomplete="on" required title="Folder name">
                                        </div>
                                        ...
                                        if ($query_category->rowCount() > 0) {
                                            foreach ($query_category as $category) {
                                                ...
                                                echo '<input type="hidden" name="folderCategory" value="' . $folder_category . '" required>';
                                            }
                                        }
                                        ?>
                                        <div class="modal-footer">
            ...
            <li class="nav-item link m-1 bg-light rounded">
                <a class="nav-link text-secondary" href="storage.php">
                ...
                <div class="container-fluid mx-auto">
                    <div class="header">
                        ...
                        if ($folder->rowCount() > 0) {
                            foreach ($folder as $folderupload) {
                                ...
                                echo '<h1 class="header font-weight-semibold"><a href="storage.php" class="text-secondary header">Storage</a> <i class="fa-solid fa-angle-right small"></i> ' . $folderCategory . ' - ' . $folderName . '</h1>';
                            }
                        }
                        ?>
                    </div>
                    <div class="my-4">
                        ...
                        <div class="d-block d-md-flex d-md-flex-row justify-content-start flex-wrap" id="file-container">
                                ...
                                foreach ($folder as $folderupload) {
                                    ...
                                    if ($folder->rowCount() > 0) {
                                        foreach ($folder as $folderupload) {
                                            ...
                                            $page = "../storage_folders.php?path=" . $mainFolder;
                                            ...
                                            '<ul class="list-group list-unstyled" id="myFolder">
                                                <li class="list group" data-category="' . $folderupload['category'] . '">
                                                    <div class="col card shadow-sm p-2 my-1 my-md-3 mr-0 mr-md-1 mr-lg-3 d-flex" id="cardFile" style="max-width: 210px; min-width: 210px; min-height: 210px; max-height: 280px;" data-toggle="tooltip" title="Category: ' . $folderupload['category'] . '">
                                                        <a href="storage_inner_folder.php?parent_path=' . $parent_path . '&path=' . $folder_path . '" class="d-block mx-auto display-1 p-3 imageContainer">
                                                        ...
                                                        <div class="mt-auto px-1">
                                                            ...
                                                            <div class="d-flex justify-content-between">
                                                                ...
                                                                <div class="dropdown-menu">
                                                                    <a href="storage_inner_folder.php?parent_path=' . $parent_path . '&path=' . $folder_path . '" class="dropdown-item"><i class="fa-regular fa-folder-open"></i> Open</a>
                                                                    <a href="#" class="dropdown-item" data-toggle="modal" data-target="#' . $folder_modal . '"><i class="fa-solid fa-pen-to-square" data-folder-id="' . $folder_id . '"></i> Rename</a>
                                                                    ...
                                                                    <a href="archive/archive_folder.php?id=' . $folder_id . '&url=' . $page . '&folder=' . $folderupload['folder'] . '&client_id=' . $client_id . '" class="dropdown-item" ><i class="fa-solid fa-box-archive"></i> Archive</a>
                                        ...
                                        echo "No folder found in this folder.";
                                    }
                                }
                            }

                            $folder = $conn->prepare("SELECT * FROM folder_upload WHERE folder_upload.client_id = :client_id ORDER BY id DESC");
                            $folder->bindParam(':client_id', $client_id);
                            $folder->execute();
                            ...
                            if ($folder->rowCount() > 0) {
                                foreach ($folder as $folderupload) {
                                    $folder_id = $folderupload['id'];
                                    $folder_modal_id = 'renameFolder_' . $folder_id;
                                    $currentFolder = $folderupload['folder'];
                                    $parent_folder = $folderupload['parent_folder'];
                                    $created = $folderupload['created'];
                                    $client_id = $folderupload['client_id'];
                            ?>
                                    <!-- Rename Folder -->
                                    <div class="modal fade" id="<?php echo $folder_modal_id; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form action="pdoaction.php" method="POST" class="user">
                                                        <!-- CSRF Token -->
                                                        <input type="hidden" name="key" value="<?php echo $folderKey ?>">
                                                        <input type="hidden" name="csrfToken" value="<?php echo $folderToken; ?>">
                                                        <!-- Variable to rename internal folder -->
                                                        ...
                                                        <input type="hidden" name="id" value="<?php echo $folder_id; ?>">
                                                        <input type="hidden" name="client_id" value="<?php echo $client_id; ?>">
                                                        <input type="hidden" name="created" value="<?php echo $created ?>" required>
                                                        <input type="hidden" name="updated" required>
                                                        <input type="hidden" name="return" value="<?php echo "storage_folders.php?path=$mainFolder"; ?>">
                                                        <input type="text" class="form-control form-control-user" name="rename_folder" id="rename" autocomplete="on" title="Rename folder" value="<?php echo $folderupload['folder_name']; ?>">
                                                        <br>
                                                        <div class="modal-footer">
                                                            <button class="btn btn-danger" type="button" data-dismiss="modal"><i class="fa">&#xf00d;</i> Cancel</button>
                                                            <button type="submit" class="btn btn-primary" name="saveSecondaryFolder"><i class="fas fa-check"></i> Save</button>
                                                        </div>
                                                    </form>
                                                </div>
                                            </div>
                    ...
                    <div class="my-4">
                        ...
                        <div class="d-block d-md-flex d-md-flex-row justify-content-start flex-wrap" id="file-container">
                            ...
                            // Get the folder path
                            $files = $conn->prepare("SELECT folder FROM folder_upload WHERE folder_upload.client_id = :client_id AND folder = :folder AND is_deleted = 0 AND is_archive = 0 ORDER BY id DESC");
                            $files->bindParam(':client_id', $client_id);
                            $files->bindParam(':folder', $mainFolder);
                            $files->execute();

                            if ($files->rowCount() > 0) {
                                foreach ($files as $folder_upload) {

                                    $folderPath = $folder_upload['folder'];
                                    $folderPath = str_replace(" ", "%20", $folderPath);

                                    $file = $conn->prepare("SELECT * FROM file_upload WHERE file_upload.client_id = :client_id AND folder = '$mainFolder' AND is_deleted = 0 AND file_id = file_id AND is_archive = 0 ORDER BY file_id DESC");
                                    ...
                                    if ($file->rowCount() > 0) {
                                        foreach ($file as $fileupload) {
                                            ...
                                            $page = "../storage_folders.php?path=$folderPath";
                                            ...
                                            switch ($extension) {
                                                case "jpg":
                                                    echo '<img src="folders/' . $mainFolder . "/" . $fileupload['fileName'] . '" class="object-fit-cover h-auto w-100 btn p-0 rounded-0" alt=' . $fileupload['title'] . ' style="min-height: 150px;">';
                                                    break;
                                                case "png":
                                                    echo '<img src="folders/' . $mainFolder . "/" . $fileupload['fileName'] . '" class="object-fit-cover h-auto w-100 btn p-0 rounded-0" alt=' . $fileupload['title'] . ' style="min-height: 150px;">';
                                                    break;
                                                            ...
                                                            <div class="d-flex justify-content-between">
                                                                <span class="overflow-hidden pr-3 cardName">' . $fileName . '</span>
                                                                    ...
                                                                    <div class="dropdown-menu">
                                                                        ...
                                                                        <a href="#" class="dropdown-item" data-toggle="modal" data-target="#' . $modal_id . '"><i class="fa-solid fa-pen-to-square" data-file-id="' . $file_id . '"></i> Rename</a>
                                                                        ...
                                                                        <a href="archive/archive_file.php?id=' . $file_id . '&url=' . $page . '" class="dropdown-item" ><i class="fa-solid fa-box-archive"></i> Archive</a>
                            ...
                            $file = $conn->prepare("SELECT * FROM file_upload WHERE file_upload.client_id = :client_id ORDER BY file_id DESC");
                            $file->bindParam(':client_id', $client_id);
                            $file->execute();

                            $folder = $conn->prepare("SELECT * FROM folder_upload WHERE folder_upload.client_id = :client_id AND is_deleted = 0 AND is_archive = 0 ORDER BY id DESC");
                            $folder->bindParam(':client_id', $client_id);
                            $folder->execute();
                                ...
                                foreach ($folder as $folder_upload) {
                                    if ($file->rowCount() > 0) {
                                        foreach ($file as $fileupload) {
                                            $file_id = $fileupload['file_id'];
                                            $modal_id = 'renameModal_' . $file_id;
                                            $uploaded = $fileupload['uploaded'];
                                            $currentFile = $fileupload['fileName'];
                                            $parent_folder = $fileupload['parent_folder'];
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form action="pdoaction.php" method="POST" class="user">
                                                                ...
                                                                <input type="hidden" name="current" value="<?php echo $currentFile ?>">
                                                                <input type="hidden" name="parent" value="<?php echo $parent_folder ?>">
                                                                <input type="hidden" name="extension" value="<?php echo $extension ?>">
                                                                <input type="hidden" name="uploaded" value="<?php echo $uploaded ?>">
                                                                <input type="hidden" name="updated">
                                                                <input type="text" class="form-control form-control-user" name="rename" id="rename" autocomplete="on" title="Rename file" value="<?php echo $fileupload['title']; ?>">
                                                                <br>
                                                                <div class="modal-footer">
                                                                    <button class="btn btn-danger" type="button" data-dismiss="modal"><i class="fa">&#xf00d;</i> Cancel</button>
                                                                    <button type="submit" class="btn btn-primary" name="saveRename"><i class="fas fa-check"></i> Save</button>
                                                                </div>
                                                            </form>
                                                        </div>
                                                    </div>
