                    ...
                    <div class="header">
                        ...
                        if ($folder->rowCount() > 0) {
                            foreach ($folder as $folderupload) {
                                ...
                                echo '<h1 class="header font-weight-semibold"><a href="recent.php" class="text-secondary header">Recent</a> <i class="fa-solid fa-angle-right small"></i> <a href="recent_folders.php?path=' . $folderupload['parent_folder'] . '" class="text-secondary header">' . $parentFolder . '</a> <i class="fa-solid fa-angle-right small"></i> ' . $folderCategory . ' - ' . $folderName . '</h1>';
                            }
                        }
                        ?>
                    </div>
