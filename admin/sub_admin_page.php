...
?>
            ...
            <li class="nav-item link bg-light m-1 rounded">
                <a class="nav-link text-secondary" href="sub_admin_page.php">
                    <i class="fas fa-users text-secondary"></i>
                    <span>Accounts</span>
                </a>
            </li>
           
            <li class="nav-item link m-1 rounded mb-5">
                <a class="nav-link" href="sub_admin_reset_ps.php">
        ...
        $("#myInput").on("keyup", function() {
            ...
            $("#myList tr").filter(function() {
                ...
                <div class="container-fluid mx-auto">
                    <div class="header">
                        <h1 class="font-weight-semibold">Manage Accounts</h1>
                    </div>
                    ...
                    <?php if ($user['is_admin'] == 0 && $user['is_deleted'] != 1) { ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="#" class="btn btn-danger banned_user" id="banned_user" data-user-id="<?php echo $user['client_id']; ?>" title="Ban">
...
<!-- Jquery for banned user button-->
<script>
$(document).ready(function() {
    $(".banned_user").click(function(e) {
        e.preventDefault();
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    type: "GET",
                    url: "admin_function/admin_remove_user.php",
                    data: { id: userId },
                    success: function(response) {
                        ...
                        switch (response) {
                            case "success":
                                Toast.fire({
                                    icon: 'success',
                                    title: 'The user has been banned successfully.',
                                    iconColor: '#28a745', 
                                }).then(() => {
                                    var delay = 100;
                                    setTimeout(function() {
                                        window.location = "sub_admin_page.php";
                                    }, delay);
                                });
                                break;
                            case "error":
                                Toast.fire({
                                    icon: 'error',
                                    title: 'There is something wrong banning this user.',
                                    iconColor: '#dc3545', 
                                }).then(() => {
                                    window.location.href = "sub_admin_page.php";
                                });
                                break;
                            default:
                                Toast.fire({
