...
?>
            ...
            <li class="nav-item link   bg-light m-1 rounded">
                <a class="nav-link   text-secondary" href="admin_reset_ps.php">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form class="user" id="password_change_form_<?php echo $user['client_id']; ?>" method="post">
                ...
                switch (response) {
                    case "successfully":
                        Swal.fire({
                            ...
                            var delay = 100;
                            setTimeout(function() {
                                window.location = "admin_reset_ps.php";
                            }, delay);
                        });
                        break;
                    case "unmatch":
