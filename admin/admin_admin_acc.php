...
?>
            ...
            <li class="nav-item link  bg-light m-1 rounded">
                <a class="nav-link  text-secondary" href="admin_admin_acc.php">
        ...
        $("#myInput").on("keyup", function() {
            ...
            $("#myList tr").filter(function() {
                ...
                <div class="container-fluid mx-auto">
                    <div class="header">
                        <h1 class="font-weight-semibold">Admin Accounts</h1>
                    </div>
        ...
        <table class="table table-bordered">
            ...
            <tbody id="myList">
                <?php while ($user = $get_user->fetch(PDO::FETCH_ASSOC)) { ?>
                    <?php if ($user['is_admin'] == 2 && $user['is_deleted'] != 1) { ?>
                        <tr>
                        ...
                        switch (response) {
                            case "success":
                                Toast.fire({
                                    ...
                                    var delay = 100;
                                    setTimeout(function() {
                                        window.location = "admin_admin_acc.php";
                                    }, delay);
                                });
                                break;
                            case "error":
                            default:
                                Toast.fire({
                                    ...
                                    window.location.href = "admin_admin_acc.php";
                                });
                                break;
                        }
                    },
